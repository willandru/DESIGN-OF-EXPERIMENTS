...
datos_ccc <- read_excel("C:/Users/willa/GITHUB/DESIGN-OF-EXPERIMENTS/Semana 14/DoE_rsm_ccc.xlsx", sheet = 1)
datos_ccc

# Codificación de datos1.37}2
...
# Importamos los datos
datos_ccc <- read_excel("C:/Users/willa/GITHUB/DESIGN-OF-EXPERIMENTS/Semana 14/DoE_rsm_ccc.xlsx", sheet = 2)
datos_ccc
