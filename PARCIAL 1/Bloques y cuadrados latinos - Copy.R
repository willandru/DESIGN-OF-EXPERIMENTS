...
datos <- read_excel("C:/Users/adrodriguez/Downloads/Bloques aleatorios/datos_bloque.xlsx", sheet="Bloques")
...
datos <- read_excel("C:/Users/adrodriguez/Downloads/Bloques aleatorios/datos_bloque.xlsx", sheet="Cuadrados Latinos")
